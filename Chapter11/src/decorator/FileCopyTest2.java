...
public class FileCopyTest2 {
	...
	public static void main(String[] args) {
		...
		// 보조스트림은 기반 스트림을 생성자의 매개변수로 사용해야 함
		// 이유는 보조스트림은 독립적으로 입출력을 수행할 수 없음
		String originFile = "C:\\javaworks\\Chapter11\\white-cat.jpg";
		String copyFlie = "C:\\javaworks\\Chapter11\\white-cat3.jpg";
		long start, end;
		try(FileInputStream fis = new FileInputStream(originFile); //기반 스트림
			FileOutputStream fos = new FileOutputStream(copyFlie); //기반 스트림
